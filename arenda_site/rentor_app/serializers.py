...
class VehicleSerializer(serializers.ModelSerializer):
    ...
    vehicle_buckets = BucketsSerializer(many=True, read_only=True)
    vehicle_additional_equipment = AdditionalEquipmentSerializer(many=True, read_only=True)
    ...
    def create(self, validated_data):
        ...
        for obj_tps in types_of_services:
            try:
                ...
                continue
            type_service_obj.renterad_set.add(instance)
